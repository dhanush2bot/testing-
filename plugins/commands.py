...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('✪ 𝙎𝙪𝙥𝙥𝙤𝙧𝙩', url="https://t.me/FilmySpotSupport_bot"),
                    InlineKeyboardButton('⌬ 𝙈𝙤𝙫𝙞𝙚 𝙂𝙧𝙤𝙪𝙥', url=GRP_LNK)
                ],[
                    InlineKeyboardButton('✇ 𝙅𝙤𝙞𝙣 𝙁𝙤𝙧 𝙐𝙥𝙙𝙖𝙩𝙚𝙨 𝘾𝙝𝙖𝙣𝙣𝙚𝙡 ✇', url=CHNL_LNK)
                  ]]
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "❆ 𝙅𝙤𝙞𝙣 𝙊𝙪𝙧 𝘾𝙝𝙖𝙣𝙣𝙚𝙡 ❆", url=invite_link.invite_link
                )
            ]
        ]
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          ...
                          InlineKeyboardButton("𝙈𝙤𝙫𝙞𝙚 𝙍𝙚𝙦𝙪𝙚𝙨𝙩 𝙂𝙧𝙤𝙪𝙥", url="t.me/TeamHMT_Movies")
                         ]
                        ]
                    )
                )
    ...
    if data.startswith("sendfiles"):
        ...
        k = await client.send_message(chat_id=message.from_user.id,text=f"<b>Get All Files in a Single Click!!!\n\n📂 ʟɪɴᴋ ➠ : {g}\n\n<i>Note: This message is deleted in 5 mins to avoid copyrights. Save the link to Somewhere else</i></b>", reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton('📂 𝘿𝙤𝙬𝙣𝙡𝙤𝙖𝙙 📂', url=g)
                    ], [
                        InlineKeyboardButton('⁉️ 𝙃𝙤𝙬 𝙏𝙤 𝘿𝙤𝙬𝙣𝙡𝙤𝙖𝙙 ⁉️', url=await get_tutorial(chat_id))
                    ]
                ]
            )
        )
        ...
        if settings['is_shortlink'] and user not in PREMIUM_USER:
            ...
            k = await client.send_message(chat_id=message.from_user.id,text=f"<b>📕Nᴀᴍᴇ ➠ : <code>{files.file_name}</code> \n\n🔗Sɪᴢᴇ ➠ : {get_size(files.file_size)}\n\n📂Fɪʟᴇ ʟɪɴᴋ ➠ : {g}\n\n<i>Note: This message is deleted in 20 mins to avoid copyrights. Save the link to Somewhere else</i></b>", reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton('📂 𝘿𝙤𝙬𝙣𝙡𝙤𝙖𝙙 𝙉𝙤𝙬 📂', url=g)
                        ], [
                            InlineKeyboardButton('⁉️ 𝙃𝙤𝙬 𝙏𝙤 𝘿𝙤𝙬𝙣𝙡𝙤𝙖𝙙 ⁉️', url=await get_tutorial(chat_id))
                        ]
                    ]
    ...
    if settings is not None:
        buttons = [
            [
                ...
                InlineKeyboardButton(
                    '𝘽𝙪𝙩𝙩𝙤𝙣' if settings["button"] else 'Tᴇxᴛ',
                    callback_data=f'setgs#button#{settings["button"]}#{grp_id}',
                ),
            ],
            [
                ...
                InlineKeyboardButton(
                    '𝙈𝙖𝙣𝙪𝙖𝙡 𝙎𝙩𝙖𝙧𝙩' if settings["botpm"] else 'Aᴜᴛᴏ Sᴇɴᴅ',
                    callback_data=f'setgs#botpm#{settings["botpm"]}#{grp_id}',
                ),
            ],
            [
            ...
            [
                ...
                InlineKeyboardButton(
                    '10 𝙈𝙞𝙣𝙪𝙩𝙚𝙨' if settings["auto_delete"] else '✘ Oғғ',
                    callback_data=f'setgs#auto_delete#{settings["auto_delete"]}#{grp_id}',
                ),
            ],
            [
        ...
        btn = [[
                InlineKeyboardButton("𝙊𝙥𝙚𝙣 𝙃𝙚𝙧𝙚 ↓", callback_data=f"opnsetgrp#{grp_id}"),
                InlineKeyboardButton("𝙊𝙥𝙚𝙣 𝙄𝙣 𝙋𝙈 ⇲", callback_data=f"opnsetpm#{grp_id}")
              ]]

        reply_markup = InlineKeyboardMarkup(buttons)
        if chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
            await message.reply_text(
                text="<b>𝘿𝙤 𝙔𝙤𝙪 𝙒𝙖𝙣𝙩 𝙏𝙤 𝙊𝙥𝙚𝙣 𝙎𝙚𝙩𝙩𝙞𝙣𝙜𝙨 𝙃𝙚𝙧𝙚 ?</b>",
                reply_markup=InlineKeyboardMarkup(btn),
            ...
            await message.reply_text(
                text=f"<b>𝘾𝙝𝙖𝙣𝙜𝙚 𝙔𝙤𝙪𝙧 𝙎𝙚𝙩𝙩𝙞𝙣𝙜𝙨 𝙁𝙤𝙧 {title} 𝘼𝙎 𝙔𝙤𝙪𝙧 𝙒𝙞𝙨𝙝 ⚙</b>",
                reply_markup=reply_markup,
                disable_web_page_preview=True,
                parse_mode=enums.ParseMode.HTML,
                reply_to_message_id=message.id
